...
if ($_POST['submit']) {
	...
	$required[] = "senate";
	$required[] = "house";
	enterResults("Election 08", "election08.php", $required, true);
}

startPoll("election08.php", $closed);
...
<li id="foli1" 
	...
	<li class="buttons">
		<input onclick="return checkOther();" id="saveForm" name='submit' class="btTxt" type="submit" value="Submit" />
	</li>
				
</ul>
	<p><small>If you are having any problems, please e-mail Adam Kommel at <a href="mailto:akommel@bowdoin.edu">akommel@bowdoin.edu</a>.</small></p>
</form>
</div>
