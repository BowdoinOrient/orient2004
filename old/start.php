	...
	function startcode($theTitle,$displayDate, $displayCurrentOrient, $articleDate, $issueNumber, $volumeNumber, $ignoreHomeLink = "no") 
	{
		...
		<?php
			...
			if(strcmp($_SERVER["HTTP_HOST"], "www.wbor.org") == 0)
				echo '<META NAME="ROBOTS" CONTENT="NOINDEX, NOFOLLOW">';
		?>
			<link href="orient3.css" rel="stylesheet" type="text/css">
							...
							<tr> 
								...
								<td width="829px" style='width: 829px; padding-right:0;' valign="top"> 
									...
									<div style='border-width: 1px 0 1px 0; border-color: #CCCCCC; border-style: solid; padding: 15px 5px 5px 5px'>
										<font class='notetitle'>BROWSER NOTICE</font>
											<p><font class="notetext">If you're seeing this notice and design, it means that you're using an outdated browser (specifically, Internet Explorer 6).  
												In addition to displaying the new design incorrectly, Internet Explorer 6 poses significant security threats to your computer and personal data, 
												so you should be upgrading regularly.  <i>The Orient</i> recommends <a href='http://www.mozilla.com'>Firefox</a>, <a href='http://www.apple.com/safari/download/'>Safari</a>, 
												<a href='http://www.microsoft.com/windows/downloads/ie/getitnow.mspx'>Internet Explorer 8</a>, or <a href='http://www.opera.com'>Opera</a>.
												</font></p>
										</div>
