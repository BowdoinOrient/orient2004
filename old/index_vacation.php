...
<div id="breaking_news">
	...
	<div class="bn_header">UPDATE: FOSTER NAMED STUDENT AFFAIRS CHIEF</div>
	<div class="bn_subheader">POSTED 4-17-06 6:37 PM</div>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr align="center" valign="top"> 
				...
				<div style="border-width: 1px 0 1px 0; border-color: #CCCCCC; border-style: solid; padding: 15px 5px 5px 5px">
					<font class="notetitle">To Our Readers:</font>
					<p><font class="notetext">Due to Fall Break, the Orient will not publish on October 13, 2006. We will resume publication on October 20. Have a great weekend!</font></p>
				</div>
				<br>
				<?php } ?>
