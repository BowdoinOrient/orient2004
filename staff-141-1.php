			...
			<div id="stafftable">
				...
				<div id="topstaff">
					...
					<div id="topeditors">
						...
						<div><p><span class="bigshot">Linda Kinstler,</span> <span class="bigshot-title">Managing Editor</span></p></div>
					</div>
				</div>
				...
				<div id="lowerstaff">
					<div class="column">
						...
						<p>Peter Griesmer<!--Jordan Lantz--></p>
					...
					<div class="column">
						...
						<p>Linda Kinstler<!--Sarah Siwak--></p>
					</div>
				</div>
