...
<div class='span-21 last'>
	<div class='span-16 authorpage'>
		<h2 class='articlesection'>Archives</h2>
			...
			<h3 class='authorpagesection' id='<?php echo $volNum ?>'><?php echo "Volume $volNum <div class='voldate'>(" . $year . "–" . ($year + 1) . ")</div>"; ?></h3>
				<ul>
...
<?php 			} ?>
			<h3 class='authorpagesection' id='CXXXIII'>Volume CXXXIII <div class="voldate">(2003–2004)</div></h3>
				<ul>
			...
			<h3 class='authorpagesection' id='CXXXII'>Volume CXXXII <div class="voldate">(2002–2003)</div></h3>
			<ul>
			...
			<h3 class='authorpagesection' id='CXXXI'>Volume CXXXI <div class="voldate">(2001–2002)</div></h3>
			<ul>
				...
				<li><a href='archives/2002-04-05/main.htm'>April 5, 2002 <a class='footnote' href='#footnote' name="asterisk">*</a></a></li>
			...
			<p><a class="footnote" href="#asterisk" name='footnote'>*</a> In this issue a longstanding numbering error in the volume was corrected. See <a href='http://orient.bowdoin.edu/orient/archives/2002-04-05/opinion_eds.htm#2'>Editors' Note</a>.</p>
			
			<h3 class='authorpagesection' id='CXXX'>Volume CXXX <div class="voldate">(2000–2001)</div></h3>
			...
			<h3 class='authorpagesection' id='internetarchive'>Volumes I–CI <div class="voldate">(1871–1921)</div></h3>
			<p>In June 2010, the <a href="http://library.bowdoin.edu/arch/index.shtml">George J. Mitchell Department of Special Collections & Archives</a> completed digitizing the first 50 volumes of the Orient (and some of the 51st), assisted by the <a href="http://bpl.org/">Boston Public Library</a> and the <a href="http://www.archive.org/">Internet Archive</a>. For more information, see <a href="http://www.bowdoin.edu/news/archives/1bowdoincampus/007544.shtml">the story on Bowdoin News</a>. The links below point to the Internet Archive.</p>
			
			<ul>
				<?php for($i = 1; $i <= 51; $i++): ?>
				<?php if($i<10) $i=sprintf("%02d",$i); ?>
				<li><a href="http://www.archive.org/stream/bowdoinorient<?=$i?>bowd">Volume <?=$i?></a> (<?=(1871+$i-1)."–".(1871+$i)?>) <a href="http://www.archive.org/download/bowdoinorient<?=$i?>bowd/bowdoinorient<?=$i?>bowd.pdf">.pdf</a> | <a href="http://www.archive.org/details/bowdoinorient<?=$i?>bowd">info</a></li>
				<?php endfor; ?>
			</ul>
