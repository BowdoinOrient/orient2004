...
$title = "The Bowdoin Orient - Ethical Practices Policy";
startPage();
?>
...
<div class='span-21 last'>
	<div class='span-16'>
		<h2 class='articlesection'>Ethical Practices Policy</h2>
		<h3 class='photocredit'>Updated Spring 2007</h3>
		<p>
		<strong>PURPOSE:</strong> The Orient adheres to professional journalistic standards. Our success as a newspaper is dependent upon the trust of our readers and sources. This document seeks to avoid any situations that may compromise this trust.</p>
        <p>
        <strong>SCOPE:</strong> This document applies to all Orient staffers, staff writers, columnists, and contributors. It does not apply to readers who submit an op-ed or letter to the editors, though such writers are encouraged to follow these guidelines.
        </p>
        <p>
        <strong>AUTHORITY:</strong> The editors-in-chief hold sole discretion over material appearing in the Orient and are responsible for the composition of the Orient's membership. The editors-in-chief reserve the right to modify operating policies as circumstances warrant.
        </p>
        <p>
        <ol>
        <li>
            <strong>The Truth.</strong> Our duty is to supply truthful information to our readers. Material should be verified to the maximum extent possible. Knowingly supplying false information for publication represents a grave violation of readers' trust.
        </li>
        <li>
            <strong>Original Reporting.</strong> You may never copy any material verbatim from any source without putting it in quotation marks and citing the source. We consider critical the concept of Òoriginal reporting.Ó Our readers rely on our reporters as first-person witnesses to the events that affect their lives. If a source is quoted or paraphrased, it is assumed that the reporter actually communicated with the source. If this is not the case, you must attribute the source of that information. For example, if you refer to a statement made by the president to the Portland Press Herald, you must indicate that the president made the statement to the Press Herald. Likewise, if you paraphrase a description written in the Brunswick Times Record, you must indicate that the information was originally reported by the Times Record. The key is making sure that it is clear to readers when you have participated in original reporting and when you have not. When the senior editorial staff determines that a writer has plagiarized, the penalty will likely include a permanent expulsion of the writer from the Orient's ranks. The Orient typically will retract the story and provide a complete explanation in its pages.
        </li>
        <li>
            <strong>Professionalism.</strong> When reporting, you are a representative of the Orient and as such should conduct yourself in a professional manner. When interviewing, arrive on time, speak in a respectful manner, and be prepared with background knowledge.
        </li>
        <li>
            <strong>Fairness.</strong> Individuals or organizations criticized in the preparation of a news story should have the opportunity to respond to criticism.
        </li>
        <li>
            <strong>Identification.</strong> In conversations with a named source that you are planning on quoting or paraphrasing, you must identify yourself as a representative of <i>The Orient</i>. When quoting public remarks at an event that is open to the student body, you do not need to identify yourself; by definition, public remarks are public. Assignments that require anonymity in obtaining information (e.g., a restaurant review) must be approved in advance by the editors-in-chief.
        </li>
        <li>
            <strong>Quotations.</strong> Material that appears in quotation marks must be the actual words used by the source. If you are not sure that you have written an exact quote in your notes, paraphrase or request clarification from the source. In accordance with New York Times policy, you may "omit extraneous syllables like 'um' and may judiciously delete false starts." We recommend that you use quotation marks in your own notes so that you may differentiate between quotations and your own paraphrasing.
        </li>
        <li>
            <strong>Tape Recording.</strong> An interview may be tape recorded only with the interviewee's consent. This policy complies with the Social Code.
        </li>
        <li>
            <strong>On the Record.</strong> As journalists, we always assume that statements made during an established interview are "on the record" unless a subject indicates otherwise. If an interviewee indicates that information is "off the record," be sure to clarify the stipulations. Some journalists interpret "off the record" to mean that the information can be used but not attributed; others believe that it means the information cannot be used at all.
        </li>
        <li>
        ...
        <li>
            <strong>Gifts.</strong> You may not accept gifts or compensation from a story's source. Exceptions: A reasonable meal offered by a source as part of an interview, souvenir items offered to all attendees of an event (for instance, at the opening of a new building), and books and CDs sent for review. You may not receive a free meal from a restaurant in the course of conducting a restaurant review.
        </li>
        <li>
            <strong>Corrections.</strong> We print nearly 30,000 words on an average week. Inevitably, some corrections will be required. If you learn of a mistake in an article, please inform your editor. It is our duty to correct or clarify erroneous information.
        </li>
        <li>
            <strong>Our Independence.</strong> The Orient is editorially independent of the College and its representatives. The College and its representatives may not demand conditions regarding publication of any material.
        </li>
        </ol>
        
        <p><small><em>The ethical guidelines of the Washington Post and the New York Times have informed portions of this policy.</em></small></p>
	</div>
