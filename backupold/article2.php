...
<?php if($anyPhotos == true) { ?>
                  <table align="right" width="1" border="0" cellspacing="0" cellpadding="0">
                    <tr> 
                      ...
                      <td>
                        <div align="center">
                        <?php $firstLink = "<a style='border:0px solid black;' href='images/$date/$largeImage' rel='lightbox$lightbox' title=\"$articleCaption<br />$photographer\">";
                        ?>
                        <a style='border:0px solid black;' href="images/<?php echo "$date/$largeImage";?>" rel="lightbox<?php echo $lightbox; ?>" title="<?php echo $articleCaption . ($articleCaption != "" ? "<br />" : "") . $photographer;?>"><img src="<?php echo "images/$date/$articleImage" ?>" border="1px solid black;">
                        <?php
                        if ($multiplePhotos) {
                        	while ($row2 = mysql_fetch_array($result2)) {
                        		...
                        		$articleCaption = $row2["caption"];
                        		echo "<a href='images/$date/$largeImage' rel='lightbox[slideshow]' style='text-decoration:none;'></a>";
                        	}
                        }
