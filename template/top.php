...
if (strpos($_SERVER['HTTP_USER_AGENT'], $ie6) !== false) {
	...
	$url = "http://orient.bowdoin.edu/orient/old/$path$queryString";
		header("Location: $url");
}
...
<head>
	...
	<meta property="fb:app_id" content="115180665171978" />
	<meta property="fb:page_id" content="113269185373845" />
	
	
	<?php if($_SERVER['PHP_SELF'] == "/orient/article.php"): ?>
	
		<meta property="og:title" content="<?=substr($title, 0, strpos($title, " - The Bowdoin Orient"))?>"/>
		<meta property="og:site_name" content="The Bowdoin Orient"/>
		<meta property="og:image" content="http://orient.bowdoin.edu/orient/images/logo-facebook-square.png"/>
		
		<!-- for bellbot.com alert -->
		<script type="text/javascript" src="https://bellbot.com/js/?code=824373413"></script>
  ...
  <!--[if IE]><link rel="stylesheet" href="../../blueprint/ie.css" type="text/css" media="screen, projection"><![endif]-->
	...
	<?php
	if ($_GET['style'] == "nick") {
?><link rel="stylesheet" href="css/orient2.css" type="text/css" media="screen, projection"><?php } else { ?><link rel="stylesheet" href="css/orient.css" type="text/css" media="screen, projection"><?php } ?>
...
<div class='container maincontainer'>
		...
		<p class='bottom'><h1 class='banner-alt'>The Bowdoin Orient</h1><a href='index.php'><img id='banner' src='images/banner.png' alt='The Bowdoin Orient' width='950px' <?php if ($_GET['style'] == "nick") { echo "height='100px'"; } ?>/></a></p>
